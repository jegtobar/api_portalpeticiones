...
class DashboardController extends Controller
{
    ...
    function getMetasAlcaldias(int $id){
        $metas = DB::table('metas_satisfechos')
        ->select(DB::raw('SUM(metas_satisfechos.meta)AS meta, SUM(metas_satisfechos.actual)AS actual'), 'alcaldias.alcaldia')
        ->join('alcaldias','alcaldias.id','=','metas_satisfechos.alcaldia_id')
    ...
    function getMetasSatisfechosByDistrito(int $id, int $distrito){
        $metas = DB::table('metas_satisfechos')
        ->select('metas_satisfechos.meta', 'metas_satisfechos.actual', 'colonias.colonia')
        ->join('colonias','colonias.id','=','metas_satisfechos.colonia_id')
        ->where([
            ['metas_satisfechos.alcaldia_id','=',$id],
    ...
    function getMetasSatisfechosDistritos(int $id){
        $metas = DB::table('metas_satisfechos')
        ->select(DB::raw('SUM(metas_satisfechos.meta)AS meta, SUM(metas_satisfechos.actual)AS actual'), 'colonias.distrito_id')
        ->join('alcaldias','alcaldias.id','=','metas_satisfechos.alcaldia_id')
        ->join('colonias','colonias.id','=','metas_satisfechos.colonia_id')
        ->where('metas_satisfechos.alcaldia_id','=',$id)
    ...
    function getMetasSatisfechosBySector(int $id){
        $metas = DB::table('metas_satisfechos')
        ->select(DB::raw('SUM(metas_satisfechos.meta)AS meta, SUM(metas_satisfechos.actual)AS actual'), 'colonias.colonia')
        ->join('alcaldias','alcaldias.id','=','metas_satisfechos.alcaldia_id')
        ->join('colonias','colonias.id','=','metas_satisfechos.colonia_id')
    ...
    function getMetasBySector(int $id){
      $metas = DB::table('metas_satisfechos')
      ->select(DB::raw('SUM(metas_satisfechos.meta)AS meta, SUM(metas_satisfechos.actual)AS actual'), 'sectores.sector')
      ->join('alcaldias','alcaldias.id','=','metas_satisfechos.alcaldia_id')
      ->join('colonias','colonias.id','=','metas_satisfechos.colonia_id')
